...
watch_data = pd.DataFrame(columns=["Brand", "Family", "Reference", "Name", "Movement", "Produced", "Limited", "Materials", "Material", "Bezel", "Glass", "Back", "Shape", "Diameter", "Height", "Lug Width", "W/R", "Nickname", "Color", "Finish", "Indexes", "Hands"])
    ...
    for link in tqdm(category_links):
        ...
        # Add the watch data to the pandas DataFrame
            try:
                ...
                print("Error: Could not extract watch data")
