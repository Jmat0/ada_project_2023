...
def image_analysis(image_array, type_of_suggestions):
    ...
    # Load the image
    #rgb_img = Image.fromarray(image_array)
    ...
    #rgb_img.thumbnail(image_size, Image.ANTIALIAS)
    # Load the image
    ...
    image_folder = "images_without_categories"
...
title = "Test our model for watch recommendations"
...
demo = gr.Interface(
    fn=image_analysis,
    inputs=[
        gr.inputs.Textbox(label="Image analysis"),
